...
<!-- page content -->
    ...
    <?php echo Html::a(Yii::t('attivita', 'Aggiungi attività'), ['create' , 'id' => $contattoModel->id], ['class' => 'btn btn-success']) ?>
...
EOL;
    ...
    ?>
                            ...
                            $dataProvider = new ActiveDataProvider([
                                'query' => \app\models\AttivitaContattoModel::find()->andFilterWhere(['idcontatto'=>$idcontatto]),
                            ]);
                            echo GridView::widget([
                                ...
                                'columns' => [
                                    ...
                                    [
                                        'attribute'=>'idattivita',
                                        'label'=>'Attività',
                                        'contentOptions' =>function ($model, $key, $index, $column){
                                            return ['class' => 'tbl_column_name'];
                                        },
                                        'content'=>function($data){
                                            return $data->attivita->descrizione;
                                        }
                                    ],
                                    // 'isactive',
