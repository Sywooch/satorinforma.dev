...
<!-- page content -->
    ...
    <?php echo Html::a(Yii::t('immobili', 'Aggiungi veicolo'), ['create' , 'id' => $contattoModel->id], ['class' => 'btn btn-success']) ?>
...
EOL;
    ...
    ?>
                            ...
                            $dataProvider = new ActiveDataProvider([
                                'query' => \app\models\VeicoliContattoModel::find()->andFilterWhere(['idcontatto'=>$idcontatto]),
                            ]);
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'content'=>function($data){
                                            ...
                                            return $data->tipoVeicolo->descrizione;
                                        }
                                    ],
                                    [
                                        'attribute'=>'valore',
