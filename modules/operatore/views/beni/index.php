...
<!-- page content -->
    ...
    <?php echo Html::a(Yii::t('immobili', 'Aggiungi bene'), ['create' , 'id' => $contattoModel->id], ['class' => 'btn btn-success']) ?>
...
EOL;
    ...
    ?>
                            ...
                            $dataProvider = new ActiveDataProvider([
                                'query' => \app\models\AltriBeniContattoModel::find()->andFilterWhere(['idcontatto'=>$idcontatto]),
                            ]);
