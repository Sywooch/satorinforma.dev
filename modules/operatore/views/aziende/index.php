...
<!-- page content -->
    ...
    <?php echo Html::a(Yii::t('immobili', 'Aggiungi azienda'), ['create' , 'id' => $contattoModel->id], ['class' => 'btn btn-success']) ?>
...
EOL;
    ...
    ?>
                            ...
                            $dataProvider = new ActiveDataProvider([
                                'query' => \app\models\AziendeContattoModel::find()->andFilterWhere(['idcontatto'=>$idcontatto]),
                            ]);
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'content'=>function($data){
                                            ...
                                            return $data->tipoAzienda->descrizione;
                                        }
                                    ],
                                    [
                                        'attribute'=>'valore',
