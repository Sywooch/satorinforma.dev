...
<div class="contact-form">
    ...
    <?php $form = ActiveForm::begin(['id' => 'create-immobili-contact-form']); ?>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <?php
            $items = ArrayHelper::map(\app\models\TipoImmobileModel::find()->all(), 'idtipo_immobile', 'descrizione');
            echo $form->field($model, 'idtipo_immobile')->dropDownList($items); ?>
