...
class VeicoliController extends Controller
{
    ...
    public function actions()
    {
        return [
            'edit-client' => [
                ...
                'modelClass' => VeicoliContattoModel::class,
                'forceCreate' => false,
            ],
    ...
    public function actionDelete($id){
        $model = $this->findModel(VeicoliContattoModel::class, $id);
    ...
    {
        $model = new VeicoliContattoModel();
        $model->idcontatto=$id;//::class, $id);

       if ($model->load(Yii::$app->request->post())) {
            if ($model->save()) {
                Yii::$app->session->setFlash('success', Yii::t('client', 'Veicolo creato correttamente.'));
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            Yii::$app->session->setFlash('success', Yii::t('client', 'Veicolo salvata.'));
